...
class DepthGenIsaacLab(DirectRLEnv):
    ...
    def _get_rewards(self) -> torch.Tensor:
        self.rew_buf[:], terminated, self.item_reward_info = self._compute_reward()
    ...
    def _compute_reward(self):
        ...
        terminated = torch.zeros(self.num_envs, device=self.device, dtype=torch.long)
        item_reward_info = {}
        return reward, terminated, item_reward_info
